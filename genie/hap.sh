...
path="/mnt/data1t/QsComp/dataset/vcf"
...
while read ref file; do
	...
	python2.7 /mnt/data1t/QsComp/dataset/hap.py/bin/hap.py ${path}/${name}.vcf.gz \
	${input}/${name}.vcf.gz -force-interactive -r ${ref} -f ${path}/${name}.bed -o ${dir}/${name}
